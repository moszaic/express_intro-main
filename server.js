...
app.use("/subdir", express.static(path.join(__dirname, "/public"))); //removed with html and router funcs in routes/root.js in MVC video
...
app.use("/subdir", require("./routes/subdir")); //removed in MVC
